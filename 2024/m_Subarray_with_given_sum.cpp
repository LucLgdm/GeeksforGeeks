...
/**********************************************************
    ...
    non negative integers, find a continuous sub-array that
    adds to a given number S and return the left and right
    ...
    Note:- You have to return an ArrayList consisting of two
    elements left and right. In case no such subarray exists
